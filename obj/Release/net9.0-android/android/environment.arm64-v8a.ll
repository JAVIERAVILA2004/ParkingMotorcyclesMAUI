...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [35 x i8] c"com.companyname.parkingmotorcycles\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [33 x i8] c"libaot-ParkingMotorcycles.dll.so\00", align 1
