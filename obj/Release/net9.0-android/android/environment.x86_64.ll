...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x07eb9bf9f182c52f, ; from name: libaot-ParkingMotorcycles.so
		i64 u0xcf8e93850e8ed71b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ParkingMotorcycles.dll.so
		ptr null; void* handle
	}, ; 28
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x3ce09beba9acb089, ; from name: aot-ParkingMotorcycles.so
		i64 u0xcf8e93850e8ed71b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ParkingMotorcycles.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xac881d535aad6bcc, ; from name: ParkingMotorcycles.dll.so
		i64 u0xcf8e93850e8ed71b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ParkingMotorcycles.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xbbafb33f00c1cfed, ; from name: aot-ParkingMotorcycles.dll.so
		i64 u0xcf8e93850e8ed71b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ParkingMotorcycles.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xcb07086e697636ab, ; from name: aot-ParkingMotorcycles
		i64 u0xcf8e93850e8ed71b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ParkingMotorcycles.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xcf8e93850e8ed71b, ; from name: libaot-ParkingMotorcycles.dll.so
		i64 u0xcf8e93850e8ed71b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ParkingMotorcycles.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xee3d676e00d07ae0, ; from name: ParkingMotorcycles.so
		i64 u0xcf8e93850e8ed71b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ParkingMotorcycles.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xee825a114edd8317, ; from name: ParkingMotorcycles
		i64 u0xcf8e93850e8ed71b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ParkingMotorcycles.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf63aa205de81b570, ; from name: libaot-ParkingMotorcycles
		i64 u0xcf8e93850e8ed71b, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ParkingMotorcycles.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [35 x i8] c"com.companyname.parkingmotorcycles\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [33 x i8] c"libaot-ParkingMotorcycles.dll.so\00", align 16
